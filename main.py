...
# ==============================================================================
# BAGIAN 10: FITUR UPLOAD (PERFORMANCE TUNED v6.29)
# ==============================================================================
...
# [CRITICAL FIX v6.29] FUNGSI UPLOAD OPTIMIZED
async def upload_confirm_admin(update, context):
    ...
    try:
        ...
        return await status_msg.edit_text(f"❌ **JSON ERROR:** {e}")
